...
var _refuge = require("./refuge");
var _refugeDefault = parcelHelpers.interopDefault(_refuge);
var _lodashThrottle = require("lodash.throttle");
var _lodashThrottleDefault = parcelHelpers.interopDefault(_lodashThrottle);
const FORM_VALUES_KEY = "feedback-form-state";
const saveFeedback = (0, _lodashThrottleDefault.default)((event)=>{
    // search parent form element
    if (event.currentTarget) {
        let from = event.currentTarget;
        while(from.nodeName !== "FORM")from = from.parentNode;
        ...
        (0, _refugeDefault.default).saveToStorage(FORM_VALUES_KEY, formValues);
    }
}, 500);
// fill form fields from local storage
const values = (0, _refugeDefault.default).loadFromStorage(FORM_VALUES_KEY);
const form = document.querySelector(".feedback-form");
for (let input of form.elements)if (input.name) {
    if (values && values[input.name]) input.value = values[input.name];
...
},{"lodash.throttle":"bGJVT","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./refuge":"394Yg"}],"bGJVT":[function(require,module,exports) {
var global = arguments[3];
/**
...
},{}],"394Yg":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["7Ih8d","eH52W"], "eH52W", "parcelRequired7c6")
